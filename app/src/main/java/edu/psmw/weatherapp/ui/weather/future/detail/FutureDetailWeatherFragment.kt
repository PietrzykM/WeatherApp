...
import edu.psmw.weatherapp.data.db.LocalDataConverter
import edu.psmw.weatherapp.internal.DateNotFoundException
...
class FutureDetailWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val date = LocalDataConverter.stringToDate(safeArgs?.dateString) ?: throw DateNotFoundException()
